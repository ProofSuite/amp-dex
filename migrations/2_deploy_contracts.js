...
module.exports = function (deployer) {
    deployer.deploy(WETH).then(async (_weth) => {
        ...
        token1 = await deployer.deploy(BNB, admin, 100000e18);
        token2 = await deployer.deploy(OMG, admin, 100000e18);
        token3 = await deployer.deploy(ZRX, admin, 100000e18);
        token4 = await deployer.deploy(AE, admin, 100000e18);
        token5 = await deployer.deploy(TRX, admin, 100000e18);
        token6 = await deployer.deploy(MKR, admin, 100000e18);
        token7 = await deployer.deploy(BAT, admin, 100000e18);
        token8 = await deployer.deploy(REP, admin, 100000e18);
        token9 = await deployer.deploy(BTM, admin, 100000e18);
        token10 = await deployer.deploy(NPXS, admin, 100000e18);
        token11 = await deployer.deploy(WTC, admin, 100000e18);
        token12 = await deployer.deploy(KCS, admin, 100000e18);
        token13 = await deployer.deploy(GNT, admin, 100000e18);
        token14 = await deployer.deploy(PPT, admin, 100000e18);
        token15 = await deployer.deploy(SNT, admin, 100000e18);
        token16 = await deployer.deploy(DGX, admin, 100000e18);
        token17 = await deployer.deploy(MITH, admin, 100000e18);
        token18 = await deployer.deploy(AION, admin, 100000e18);
        token19 = await deployer.deploy(LRC, admin, 100000e18);
        token20 = await deployer.deploy(FUN, admin, 100000e18);
        token19 = await deployer.deploy(LRC, admin, 100000e18);
        token20 = await deployer.deploy(FUN, admin, 100000e18);
        token21 = await deployer.deploy(KNC, admin, 100000e18);
        token22 = await deployer.deploy(LOOM, admin, 100000e18);
        token23 = await deployer.deploy(PRFT, admin, 100000e18);
    })
};
